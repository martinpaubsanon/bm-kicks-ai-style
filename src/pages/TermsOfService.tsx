    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">3. Brand Affiliation & Trademarks</h2>
            <p className="text-foreground/80 leading-relaxed mb-4">
              BM Kicks is an independent retailer and reseller of authentic, branded sneakers and footwear. We are not an authorized dealer, distributor, or affiliate of Nike, Adidas, Jordan, Puma, New Balance, or any other brands featured on this Website. All product names, logos, and trademarks are property of their respective owners.
            </p>
            <p className="text-foreground/80 leading-relaxed">
              Any reference to brand names is solely to identify the products being resold, and does not imply sponsorship, endorsement, or partnership. BM Kicks has no business relationship with these manufacturers, beyond the lawful resale of genuine products obtained through commercial channels.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">4. Product Sourcing & Market Region</h2>
            <p className="text-foreground/80 leading-relaxed mb-4">
              Products sold on the Website are acquired from reputable retailers, authorized distributors, and verified commercial suppliers, both domestically and internationally.
            </p>
            <p className="text-foreground/80 leading-relaxed mb-4">
              As products may come from different countries or regions ("gray market" goods), there may be differences compared to items purchased from manufacturer-authorized channels, such as:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-foreground/80">
              <li>Packaging or labeling variations</li>
              <li>Missing warranty cards or promotional items</li>
              <li>Regional or international model codes</li>
              <li>No manufacturer warranty or support</li>
            </ul>
            <p className="text-foreground/80 leading-relaxed mt-4">
              We disclose any known material differences in product listings. All goods are checked for authenticity before listing. For further details, please review our <a href="/authenticity-guarantee" className="text-accent hover:underline">Authenticity Guarantee</a>.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">5. Eligibility</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">6. Products and Pricing</h2>
            <h3 className="text-xl font-semibold mb-3 text-foreground">6.1 Product Information</h3>
            <p className="text-foreground/80 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">6.2 Pricing</h3>
            <p className="text-foreground/80 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">6.3 Product Availability</h3>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">7. Orders and Payment</h2>
            <h3 className="text-xl font-semibold mb-3 text-foreground">7.1 Order Acceptance</h3>
            <p className="text-foreground/80 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">7.2 Payment</h3>
            <p className="text-foreground/80 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">7.3 Order Confirmation</h3>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">8. Account Registration</h2>
            <p className="text-foreground/80 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">9. Authenticity Guarantee</h2>
            <p className="text-foreground/80 leading-relaxed">
              BM Kicks guarantees that all products sold on our Website are 100% authentic. We source our products from reputable retailers and verified commercial suppliers. If you receive a product that you believe is not authentic, please contact us immediately. For more information, please see our <a href="/authenticity-guarantee" className="text-accent hover:underline">Authenticity Guarantee page</a>.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">10. Manufacturer Warranties</h2>
            <p className="text-foreground/80 leading-relaxed mb-4">
              Unless expressly stated in the product description, BM Kicks does not provide or extend the original manufacturer's warranty for any products sold on our Website. Because we are not an authorized dealer, the manufacturer may decline to honor warranty claims for products purchased from us.
            </p>
            <p className="text-foreground/80 leading-relaxed">
              Our obligations are limited to authenticity verification, accurate description, and the warranties outlined in our Return Policy and Authenticity Guarantee.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">12. User Conduct</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">13. Shipping and Delivery</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">14. Returns and Refunds</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">15. Limitation of Liability</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">16. Disclaimer of Warranties</h2>
            <p className="text-foreground/80 leading-relaxed">
              The Website and all products are provided "as is" and "as available" without warranties of any kind, either express or implied. We do not warrant that the Website will be uninterrupted, error-free, or free of viruses or other harmful components. Products do not include manufacturer warranties unless explicitly stated.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">17. Indemnification</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">18. Consumer Protection & Governing Law</h2>
            <p className="text-foreground/80 leading-relaxed mb-4">
            ...
            <p className="text-foreground/80 leading-relaxed">
              However, if you are a consumer located outside Qatar, mandatory consumer protection rules and rights of your country of residence may also apply and are not excluded by these Terms.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">19. Severability</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-foreground">19. Entire Agreement</h2>
            <p className="text-foreground/80 leading-relaxed">
              These Terms, along with our Privacy Policy, Return Policy, Shipping Policy, Cookie Policy, and Brand Disclaimer, constitute the entire agreement between you and BM Kicks regarding your use of the Website.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-muted rounded-lg">
              <p className="text-foreground/80"><strong>Email:</strong> legal@bmkicks.shop</p>
